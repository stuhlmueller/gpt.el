...
class TestOpenAIProvider:
    ...
    def test_call_openai_with_raw_prompt(self, mock_openai):
    ...
    @patch('providers.openai_provider.openai')
    def test_call_openai_with_messages(self, mock_openai):
    ...
    @patch('providers.openai_provider.openai')
    def test_call_openai_with_web_search(self, mock_openai):
    ...
    def test_handle_openai_stream_text_output(self, monkeypatch):
        ...
        # Type ignore for test - we're passing a mock iterator
        result_gen = handle_openai_stream(iter(events))  # type: ignore
        result = ''.join(result_gen)

        assert result == "Hello world!"

    def test_handle_openai_stream_with_reasoning(self, monkeypatch):
    ...
    def test_handle_openai_stream_with_web_search(self, monkeypatch):
        ...
        events = [
            ...
            Mock(type="response.function_call_arguments.delta", delta='{"query": "latest news"}'),
